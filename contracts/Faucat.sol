...
contract Faucet {
    ...
    function withdraw() public {
        ...
        require(withdrawalAmount <= 1000 * (10 ** 18), "Request exceeds maximum withdrawal amount of 1000 GNT");
    ...
    // Add a small delay to make sure the funds are actually transferred
    require(_token.balanceOf(address(this)) == 0, "Contract balance not empty");
}
